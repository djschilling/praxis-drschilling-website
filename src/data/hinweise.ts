...
export const hinweise: Hinweis[] = [
  {
    ...
    text:
      'Am Donnerstag, 24. September, und Freitag, 25. September 2026 bleibt unsere Praxis geschlossen. Ab Montag, 28. September, sind wir wieder wie gewohnt für Sie da.',
